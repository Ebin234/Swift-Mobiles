    ...
    <div className="min-h-screen bg-gray-50 flex justify-center items-start p-10">
      <div className="bg-white shadow-lg rounded-xl p-8 w-full max-w-2xl border border-gray-200">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
          <label className="block font-medium text-gray-700 mb-1">Choose an option:</label>
          <select name="category" value={formData.category} onChange={handleChange} className="w-full border text-black border-gray-300 rounded-md px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none" >
          ...
          <div>
            <label className="block font-medium text-gray-700 mb-1">Product Link</label>
            <input
              type="text"
              name="productLink"
